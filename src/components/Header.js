    ...
    <section id="header">
      <div className="container mx-auto flex px-10 py-20 md:flex-row flex-col">
        <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
          <h1 className="title-font text-gray-200 title-font  mb-4 text-4xl font-extrabold leading-10 tracking-tight sm:text-5xl sm:leading-none md:text-6xl">Hi, I'm Manan!</h1>
          <p className="mb-8 leading-relaxed text-xl"> I am a Software Developer, Data Scientist, and Technical Project Manager. I develop production-grade software that has meaningful impact from inception to implementation.</p>
        ...
        <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 m-auto">
          <Player
              autoplay
              loop
              src="https://assets10.lottiefiles.com/packages/lf20_o6spyjnc.json"
